...
<html lang="en">
	...
	<head><base href="">
		...
		<!--end::Layout Themes-->
		<script src="{{secure_asset('js/jquery-2.0.3.min.js')}}"></script>
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
								...
								<li class="menu-item" aria-haspopup="true" id="admin_applications">
									<a href="/panel/admin/students" class="menu-link">
								...
								<!-- <li class="menu-item" aria-haspopup="true" id="admin_subscribers">
									<a href="/panel/admin/setup" class="menu-link">
										<span class="svg-icon menu-icon">
											<i class="fa fa-cog"></i>
										</span>
							...
							<ul class="menu-nav">
								<li class="menu-section">
									<h4 class="menu-text">Student</h4>
									<i class="menu-icon ki ki-bold-more-hor icon-md"></i>
								</li>
								<li class="menu-item" aria-haspopup="true" id="admin_dashboard">
									<a href="/panel/student" class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
