...
<html lang="en">
	...
	<head><base href="">
		...
		<meta name="description" content="Jujiedso Fibr Optics - A local internet service provider in that caters primarily in Aurora, Zamboanga Del Sur" />
		<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
		<meta property="og:image" content="{{asset('assets/media/jujiedso_logo.jpg')}}"><!-- link to image for socio -->
		<link rel="canonical" href="https://jujiedso.com" />
		<!--begin::Fonts-->
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			<!--begin::Logo-->
			<a href="/">
				<img alt="Logo" src="{{asset('assets/media/jujiedso_logo.jpg')}}" width="200" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						...
						<a href="/" class="brand-logo">
							<img alt="Logo" src="{{asset('assets/media/jujiedso_logo.jpg')}}" width="200" style="margin-top:20px;"/>
						</a>
						<!--end::Logo-->
						<!--begin::Toggle-->
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
								...
								<li class="menu-item" aria-haspopup="true" id="admin_applications">
									<a href="/panel/admin/applications" class="menu-link">
                                ...
                                <li class="menu-item" aria-haspopup="true" id="admin_subscribers">
									<a href="/panel/admin/subscribers" class="menu-link">
                                ...
                                <li class="menu-item" aria-haspopup="true" id="admin_packages">
									<a href="/panel/admin/packages" class="menu-link">
										<span class="svg-icon menu-icon"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Communication\Mail-attachment.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												<rect x="0" y="0" width="24" height="24"/>
								...
								<!-- <li class="menu-item" aria-haspopup="true" id="admin_products">
									<a href="/panel/admin/products" class="menu-link">
								...
								<li class="menu-item" aria-haspopup="true" id="admin_plans">
									<a href="/panel/admin/plans" class="menu-link">
										<span class="svg-icon menu-icon"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Files\Folder-solid.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												<rect x="0" y="0" width="24" height="24"/>
                                ...
                                <li class="menu-item" aria-haspopup="true" id="admin_employees">
									<a href="/panel/admin/employees" class="menu-link">
										<span class="svg-icon menu-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												<polygon points="0 0 24 0 24 24 0 24"/>
								...
								<li class="menu-item" aria-haspopup="true" id="admin_users">
									<a href="/panel/admin/users" class="menu-link">
										<span class="svg-icon menu-icon"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Communication\Shield-user.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												<rect x="0" y="0" width="24" height="24"/>
								...
								<li class="menu-item" aria-haspopup="true" id="admin_settings">
									<a href="/panel/finance" class="menu-link">
										...
										<span class="menu-text">Summarry</span>
									</a>
								</li>
								<li class="menu-item" aria-haspopup="true" id="admin_settings">
									<a href="/panel/finance/bills" class="menu-link">
									<span class="svg-icon menu-icon"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Shopping\Bitcoin.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											<rect x="0" y="0" width="24" height="24"/>
								...
								<li class="menu-item" aria-haspopup="true" id="admin_settings">
									<a href="/panel/finance/payments" class="menu-link">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
											<span class="svg-icon menu-icon"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Shopping\Money.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<rect x="0" y="0" width="24" height="24"/>
					...
					<div id="kt_header" class="header header-fixed">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                                ...
                                <h5 class="text-dark font-weight-bold mt-8 mb-2 mr-5">{{$page_name}}</h5>
								</div>
								<!--end::Header Menu-->
							</div>
