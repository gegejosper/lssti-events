								...
								<div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                            ...
                                            <a href="/panel/admin/users/{{$user->id}}" class="btn btn-primary btn-sm float-left" style="margin-right:3px;">
                                            <i class="fa fa-pen" style="font-size:10px;"></i>
                                            </a>
                                           
                                            @if($user->status == 'active')
                                                <a href="javascript:;" id="modifyuser{{$user->id}}" class="btn btn-sm btn-warning modify-staff"
                                                    data-user_id="{{$user->id}}"
                                                    data-user_status="inactive">
                                                    <i class="far fa-eye-slash" style="font-size:10px;"></i>
                                                </a>
                                                @elseif($user->status == 'inactive')
                                                <a href="javascript:;" id="modifyuser{{$user->id}}" class="btn btn-sm btn-info modify-staff"
                                                    data-user_id="{{$user->id}}"
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        <label>Roles</label> <span class="form-text text-muted">Please check the roles you want to assign on the user</span>
                                        <br>
...
<div class="modal fade" id="adduserModalSuccess" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
