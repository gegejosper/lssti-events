				...
				<div class="col-xl-3">
					...
					<div class="card card-custom bg-light-success card-stretch gutter-b">
						...
						<div class="card-body">
							...
							<span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">19</span>
				...
				<div class="col-xl-3">
					...
					<div class="card card-custom bg-light-danger card-stretch gutter-b">
						...
						<div class="card-body">
							...
							<span class="font-weight-bold text-muted font-size-sm">Subscriber</span>
						</div>
						<!--end::Body-->
					</div>
					<!--end::Stats Widget 26-->
				...
				<div class="col-xl-3">
					...
					<div class="card card-custom bg-light-info card-stretch gutter-b">
						...
						<div class="card-body">
							...
							<span class="font-weight-bold text-muted font-size-sm">Past Due Subscribers</span>
						</div>
						<!--end::Body-->
					</div>
					<!--end::Stats Widget 27-->
				...
				<div class="col-xl-3">
					...
					<div class="card card-custom bg-light-warning card-stretch gutter-b">
						...
						<div class="card-body">
							...
							<span class="font-weight-bold text-muted font-size-sm">Collectibles</span>
						</div>
						<!--end::Body-->
					</div>
					<!--end::Stat: Widget 28-->
