					...
					<div class="card card-custom gutter-b">
						...
						<div class="card-header border-0 pt-5">
							<h3 class="card-title align-items-start flex-column">
								<span class="card-label font-weight-bolder text-dark">{{$event->event_name}} Event Log Report</span>
								<span class="text-muted mt-3 font-weight-bold font-size-sm">Login / Logout of Students of the Event.
								</span>
							</h3>
						</div>
						<!--end::Header-->
