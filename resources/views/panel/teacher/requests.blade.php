						...
						<table class="table table-head-custom table-head-bg table-borderless table-vertical-center" id="subjectScheduleTable">
							<thead>
								<tr class="text-left text-uppercase">
                                    ...
                                    <th style="" class="pl-7">
										<span class="text-dark-75">Student</span>
									</th>
									<th>Time</th>
									<th>Day</th>
                                    <th></th>
                            ...
                            <tr>
                                ...
                                <td>{{$request->schedule->subject_time}}</td>
                                <td>
                                    @foreach($request->schedule->days as $day)
                                    {{$day->schedule_day}}
                                    @endforeach
                                </td>
                              
                                <td>
                                    <a href="javascript:;" class="btn btn-light-success font-weight-bolder font-size-sm approve-subject"
                                        data-schedule_id="{{$request->id}}"><i class="fas fa-check"></i></a>
                                    <a href="javascript:;" class="btn btn-light-danger font-weight-bolder font-size-sm decline-subject"
                                        data-schedule_id="{{$request->id}}"><i class="fas fa-times"></i></a>
                                </td>
                            </tr>
                            @empty
                            <tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                @csrf
                <div class="alert alert-danger" role="alert"> Are you sure you to approve on this student?</div>
            </div>
...
@endsection
@section('jslinks')
<script src="{{asset('js/teacher_enroll.js')}}"></script>
